...
public class RegisterActivity extends AppCompatActivity {
    ...
    //После нажатия на кнопку запускаем метод регистрациии.
    //Берем даные с полей, и если проверил валидатор на соответсвие, тогда
    //делаем запрос о регистрации с именем, логином и паролем. Если все успешно - сохраняем оба токена и стартуем PostActivity.
    //Если нет тогда запускаем клас обработки ошиибок.
    ...
    //По нажатию на кнопку переходим в LoginActivity
