...
public class CustomAuthenticator implements Authenticator {
    ...
    //Гетер c помощью которого объект данного класа заряжается токен менеджером
    ...
    public Request authenticate(Route route, Response response) throws IOException {
        ...
        //Если запрос успешно принят(рефреш токен подошел) то получаем новый аксес токен с тела запроса и сохраняем его
        //Возвращаем запрос
        if(res.isSuccessful()){
